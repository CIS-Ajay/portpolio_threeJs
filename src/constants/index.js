export const navLinks = [
  ...
  },  
  {
    id: 5,
    name: 'Resume',
    href: 'public/assets/ReactJs.pdf', 
  },
...
export const calculateSizes = (isVerySmall, isSmall, isMobile, isTablet) => {
  return {
    deskScale: isSmall ? 0.05 : isMobile ? 0.06 : 0.065,
    deskPosition: isMobile ? [0.5, -4.5, 0] : [0.25, -5.5, 0],
    cubePosition: isSmall ? [3, -6.8, 0] : isMobile ? [5, -5, 0] : isTablet ? [5, -5, 0] : [9, -5.5, 0],
    reactLogoPosition: isVerySmall ? [0, 0, 0] : isSmall ? [3, 4, 0] : isMobile ? [5, 4, 0] : isTablet ? [5, 4, 0] : [12, 3, 0],
    ringPosition: isSmall ? [-5, 8, 0] : isMobile ? [-10, 10, 0] : isTablet ? [-12, 10, 0] : [-24, 10, 0],
    targetPosition: isSmall ? [-5, -11, -10] : isMobile ? [-9, -10, -10] : isTablet ? [-11, -7, -10] : [-13, -13, -10],
  };
};
...
export const workExperiences = [

  {
    ...
    title: "CIS is my collaborative design platform of choice. I utilize it to work seamlessly with team members and clients, facilitating real-time feedback and design iterations. Its cloud-based.",
    title1: '• Designed and implemented scalable system architectures for multiple projects.',
    title2: '• Collaborated with cross-functional teams, adhering to best coding practices and tight deadlines.',
    title3: '• Utilized expertise in React, Angular, Node, Express, MongoDB developed live projects with optimizing user interfaces.',
